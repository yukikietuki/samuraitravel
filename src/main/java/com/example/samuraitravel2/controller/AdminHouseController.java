...
import com.example.samuraitravel2.form.HouseRegisterForm;
import com.example.samuraitravel2.service.HouseService;
import com.example.samuraitravel2.entity.House;
import com.example.samuraitravel2.repository.HouseRepository;

import com.example.samuraitravel2.form.HouseEditForm;
@Controller
...
public class AdminHouseController {
    ...
    public String create(@ModelAttribute @Validated HouseRegisterForm houseRegisterForm, BindingResult bindingResult, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute("successMessage", "民泊を登録しました。");
